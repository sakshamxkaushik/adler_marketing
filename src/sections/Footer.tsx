      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div>
            ...
            <p className="text-sm mb-2 text-gray-300">TEL : 02.874.6182</p>
          ...
          {/* <div>
            ...
            <form className="flex gap-2">
              <Input
                ...
                className="flex-grow bg-gray-800 text-white rounded-full placeholder-gray-400"
              />
        ...
        <div className="border-t border-gray-700 pt-8 flex justify-between items-center">
          ...
          <p className="text-sm w-1/3 text-center text-gray-300">© 2024 Adler. All rights reserved</p>
          <div className="w-1/3 flex justify-end space-x-4">
            <a href="https://www.linkedin.com/company/adler-universe/" className="text-gray-400 hover:text-gray-300">
              <span className="sr-only">LinkedIn</span>
              <Linkedin className="h-6 w-6" />
            </a>
            <a href="https://www.instagram.com/adler.universe/" className="text-gray-400 hover:text-gray-300">
